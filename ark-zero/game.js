...
const glorySlides = [
  ...
  },
  {
    image: assets.glory4,
    title: "方舟群起航",
    text: "当内战的阴影越过月面，火种派开始把方舟送往黑暗。方舟级舰体保持同一三角楔形外观体系：黑色长楔、蓝色能量脉络与侧向圆形核心。方舟零号被留在南极冰下，负责守住边缘世界的遗书；其他方舟驶向几百光年之外。"
  },
  {
    image: assets.glory5,
    title: "边缘殖民地",
...
const loreEntries = {
  ...
  starmap: {
    ...
    body: [
      ...
      { type: "p", text: "所有方舟级舰体都遵循同一种三角楔形外观体系：尖锐舰首、低矮长楔、黑色复合装甲、蓝色能量脉络、侧向圆形核心与下方支撑结构。不同编号可以拥有不同损伤、涂装或尺度，但不能改变基础轮廓。" },
  ...
  colonies: {
    title: "远方方舟与失联殖民地",
    body: [
      { type: "p", text: "方舟零号的编号从来不是装饰。资料库显示，‘零号’代表母星保存点，承担记录、审查与封存职责；在它之后有许多远行者。那些方舟级舰体共享同一套三角楔形工程语言与识别特征，只是编号、任务、损伤状态和远航目的不同。" },
